...
def runExample():
    data_dir = '/home/jexinia/SCR/autonav_software_2023/autonav_ws/src/autonav_vision/KITTI_sequence_2'  # Try KITTI_sequence_2 too
    ...
    for i, gt_pose in enumerate(tqdm(vo.gt_poses, unit="pose")):
        if i == 0:
            ...
            xplotvals.append(cur_pose[0,3])
            yplotvals.append(cur_pose[2,3])
        
        gt_path.append((gt_pose[0, 3], gt_pose[2, 3]))
        estimated_path.append((cur_pose[0, 3], cur_pose[2, 3]))

    fig, ax = plt.subplots()
    ax.plot(xplotvals, yplotvals, linewidth= 2.0)
    plt.show() 
